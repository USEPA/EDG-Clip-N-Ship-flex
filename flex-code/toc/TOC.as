...
//
////////////////////////////////////////////////////////////////////////////////
package widgets.FrClipAndShip.toc
{
	...
	public class TOC extends Tree
	{
	    ...
	    public function TOC(map:Map = null)
	    {
	        ...
	        itemRenderer = new ClassFactory(widgets.FrClipAndShip.toc.tocClasses.TocItemRenderer);
