...
package widgets.FrClipAndShip.toc.tocClasses
{
	...
	import widgets.FrClipAndShip.DetailsWindow;
	import widgets.FrClipAndShip.toc.controls.CheckBoxScaleDependant;
	...
	public class TocItemRenderer extends TreeItemRenderer
	{
		...
		[Embed(source="widgets/FrClipAndShip/assets/images/metadata.png")]
		[Bindable]
		...
		override public function set data(value:Object):void
		{
			...
			if (!_btn)
			{
				_btn = new Image();
				_btn.id = "btnMeta"
				_btn.toolTip = "Show EDG Metadata";
				_btn.width = 20;
				_btn.height = 20;
			...
			if (tocItem && tocItem.label != "dummy")
			{
				...
				// Changed by frank since setting above would not work
