...
package widgets.FrClipAndShip.toc.tocClasses
{
	...
	import widgets.FrClipAndShip.toc.tocClasses.*;
	import widgets.FrClipAndShip.toc.tocClasses.LegendDataClassItem;
	import widgets.FrClipAndShip.toc.tocClasses.LegendDataItem;
	import widgets.FrClipAndShip.toc.tocClasses.LegendSymbolItem;
	import widgets.FrClipAndShip.toc.tocClasses.TocLayerInfoItem;
	import widgets.FrClipAndShip.toc.utils.MapUtil;
	...
	public class TocMapLayerItem extends TocItem
	{
	    ...
	    public function TocMapLayerItem(layer:Layer, labelFunction:Function = null, isMapServiceOnly:Boolean = false, excludedLayers:ArrayCollection = null, showMeta:Boolean = false, iscollapsed:Boolean = false)
	    {
	        super();
